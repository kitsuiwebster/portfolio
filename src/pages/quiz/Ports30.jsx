...
function Ports30() {
    ...
    const [questions, setQuestions] = useState(pickRandomQuestions(initialQuestions, 30));
    ...
    useEffect(() => {
        setQuestions(pickRandomQuestions(initialQuestions, 30));
    }, []);
