...
function Ports50() {
    ...
    const [questions, setQuestions] = useState(pickRandomQuestions(initialQuestions, 50));
    ...
    useEffect(() => {
        setQuestions(pickRandomQuestions(initialQuestions, 50));
    }, []);
        ...
        <div className="port-numbers">
            {!quizEnded ? (
                <div className='port-numbers-container'>
                    <h1>{questions[currentQuestionIndex].name}</h1>
